...
export default function Footer() {
  return (
    <footer className="flex justify-stretch w-full py-4 text-center">
      <div className="flex  mx-auto gap-10">
        <span className="text-sm">x</span>
        <span className="text-sm">y</span>
        <span className="text-sm">z</span>
        <span className="text-sm">
          &copy; 2024 My Website. bla bla bla all rights reserved.
        </span>
        <span className="flex flex-row text-sm gap-3">
          github{" "}
          <svg
